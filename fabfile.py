...
if not hasattr(env, "proj_app"):
    env.proj_app = real_project_name("ChairBlog")
...
def create():
    ...
    with project():
        if env.reqs_path:
            pip("git+https://github.com/fermorltd/mezzanine.git@2.2-compat")
            pip("-U git+https://github.com/fermorltd/filebrowser-safe.git@2.2-compat")
            pip("-U git+https://github.com/fermorltd/grappelli-safe.git@2.2-compat")
            pip("-r %s/%s" % (env.proj_path, env.reqs_path))
