...
urlpatterns += [
    ...
    path("blog/", theme.views.blog_redirect),

    # PROJECTS PAGE
    # -------------

    path("projects/", theme.views.project_list, name='project_list'),
    path("projects/<slug:title>", theme.views.project_detail, name='project_detail'),
